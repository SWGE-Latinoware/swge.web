...
A partir de *clone* (`git clone https://github.com/SWGE-Latinoware/swge.web.git`), é necessário a execução da instalação dos módulos escolhidos dentro do arquivo `package.json`, neste caso utilizando o comando `npm install`. 
